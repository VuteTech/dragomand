...
### Езикови модели {#language-models}
...
За да инсталирате всички езици наведнъж, инсталирайте
`dragomand-models-all`, мета пакет, който зависи от всички тях (около
3 GB), със същата команда на пакетния мениджър като по-горе.
